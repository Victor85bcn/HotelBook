...
public class frmusuariologin extends javax.swing.JFrame {
    ...
    public frmusuariologin() {
        initComponents();
        this.setTitle("Acceso a HotelBook");
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Files/Usuarios.png"))); // NOI18N
    ...
    private void btningresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btningresarActionPerformed
        ...
        try {
            ...
            if (func.totalregistros > 0) { //Si ha encontrado el usuario y el password en la BBDD
                this.dispose();
                frminicio form = new frminicio(); //Activa la ventana de inicio
                form.toFront();
                form.setVisible(true);
                
                //Enviamos los datos de la tabla a la pantalla de inicio
                ...
                frminicio.lblapellido1.setText(tablalistado.getValueAt(0, 2).toString());
                frminicio.lblapellido2.setText(tablalistado.getValueAt(0, 3).toString());
                frminicio.lblacceso.setText(tablalistado.getValueAt(0, 4).toString());
                
                    if (!frminicio.lblacceso.getText().equals("Administrador")) { //Si el usuario existe pero el acceso es diferente a Administrador
                        frminicio.mnuarchivo.setEnabled(false); //Deshabilita el botón de Archivo.
                        frminicio.mnuconfiguraciones.setEnabled(false);  //Deshabilita el botón de Configuraciones..             
                }  
            } else {
                JOptionPane.showMessageDialog(rootPane, "Usuario o contraseña incorrectos.", "Acceso a HotelBook", JOptionPane.ERROR_MESSAGE); //Si no ha encontrado el usuario da mensaje de error.
            }
